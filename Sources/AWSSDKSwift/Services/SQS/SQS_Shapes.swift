...
extension SQS {
    ...
    public struct AddPermissionRequest: AWSShape {
        ...
        public init(aWSAccountId: [String]? = nil, actionName: [String]? = nil, label: String, queueUrl: String) {
    ...
    public struct ChangeMessageVisibilityBatchRequest: AWSShape {
        ...
        public init(changeMessageVisibilityBatchRequestEntry: [ChangeMessageVisibilityBatchRequestEntry]? = nil, queueUrl: String) {
    ...
    public struct ChangeMessageVisibilityBatchResult: AWSShape {
        ...
        public init(batchResultErrorEntry: [BatchResultErrorEntry]? = nil, changeMessageVisibilityBatchResultEntry: [ChangeMessageVisibilityBatchResultEntry]? = nil) {
    ...
    public struct DeleteMessageBatchRequest: AWSShape {
        ...
        public init(deleteMessageBatchRequestEntry: [DeleteMessageBatchRequestEntry]? = nil, queueUrl: String) {
    ...
    public struct DeleteMessageBatchResult: AWSShape {
        ...
        public init(batchResultErrorEntry: [BatchResultErrorEntry]? = nil, deleteMessageBatchResultEntry: [DeleteMessageBatchResultEntry]? = nil) {
            self.batchResultErrorEntry = batchResultErrorEntry
    ...
    public struct GetQueueAttributesRequest: AWSShape {
        ...
        public init(attributeName: [QueueAttributeName]? = nil, queueUrl: String) {
    ...
    public struct ReceiveMessageRequest: AWSShape {
        ...
        public init(attributeName: [QueueAttributeName]? = nil, maxNumberOfMessages: Int32? = nil, messageAttributeName: [String]? = nil, queueUrl: String, receiveRequestAttemptId: String? = nil, visibilityTimeout: Int32? = nil, waitTimeSeconds: Int32? = nil) {
            self.attributeName = attributeName
    ...
    public struct SendMessageBatchRequest: AWSShape {
        ...
        public init(queueUrl: String, sendMessageBatchRequestEntry: [SendMessageBatchRequestEntry]? = nil) {
            self.queueUrl = queueUrl
    ...
    public struct SendMessageBatchResult: AWSShape {
        ...
        public init(batchResultErrorEntry: [BatchResultErrorEntry]? = nil, sendMessageBatchResultEntry: [SendMessageBatchResultEntry]? = nil) {
            self.batchResultErrorEntry = batchResultErrorEntry
    ...
    public struct UntagQueueRequest: AWSShape {
        ...
        public init(queueUrl: String, tagKey: [String]? = nil) {
            self.queueUrl = queueUrl
            self.tagKey = tagKey
        }
