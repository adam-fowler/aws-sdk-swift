...
let package = Package(
    ...
    products: [
        ...
        .library(name: "S3Extension", targets: ["S3Extension"]),
    ...
    dependencies: [
        .package(url: "https://github.com/adam-fowler/aws-sdk-swift-core.git", .branch("httpclient"))
    ],
    targets: [
